...
public class PostGameAccountDTO {
	...
	@Min(value = 0, message = "Số Tinh Hoa Lam không được nhỏ hơn 0!")
	private int tinhhoalam = 0;
	@Min(value = 0, message = "Số RP không được nhỏ hơn 0!")
	private int rp = 0;
	...
	private GameAccountStatus gameAccountStatus = GameAccountStatus.SELLING;
